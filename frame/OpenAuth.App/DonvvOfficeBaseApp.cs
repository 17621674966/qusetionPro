...
namespace OpenAuth.App
{
    ...
    public class DonvvOfficeBaseApp<T> where T:BaseEntity
    {
        /// <summary>
        /// 用于事务操作
        /// </summary>
        /// <value>The unit work.</value>
        public IUnitWork UnitWork = new DonvvOfficeUnitWork();
        /// <summary>
        /// 用于普通的数据库操作
        /// </summary>
        /// <value>The repository.</value>
        public IRepository<T> Repository = new DonvvOfficeBaseRepository<T>();
        ...
        {
            Repository.Delete(u => ids.Contains(u.RowGuid));
        }

        public T Get(string id)
        {
            return Repository.FindSingle(u => u.RowGuid == id);
        }
