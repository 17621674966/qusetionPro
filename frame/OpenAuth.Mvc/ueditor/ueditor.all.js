...
(function () {
    ...
    /**
     * 该参数将添加一个参数： selected， 参数类型为一个Object， 形如{ 'align': 'center', 'valign': 'top' }， 表示单元格的初始
...
(function () {
    ...
    Menu.prototype = {
        ...
        createItem:function (item) {
            //添加一个参数menu, 该参数存储了menuItem所对应的menu引用
            item.menu = this;
    ...
    /**
     * @update 2013/04/03 hancong03 添加一个参数menu, 该参数存储了menuItem所对应的menu引用
     * @type {Function}
     */
